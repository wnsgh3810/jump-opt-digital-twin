...
def main():
    ...
    rows = []
    # ── 0429: 6 subs ──
    subs = ["60_0.75_60_2", "90_1.5_90_2.5", "120_2_120_2", "120_2.2_200_2.8",
    ...
    json.dump(rows, open(DST / "exp3_rows.json", "w"), indent=1)
    # ── 집계 ──
    ...
    fig.tight_layout(); fig.savefig(DST / "exp3_429_lambda.png", dpi=110)
    print("saved", DST / "exp3_429_lambda.png", flush=True)
