...
def evaluate(v23, verbose=False, keep_rows=True):
    ...
    kr = RU.rise_of(d_dq)       # Phase 4c 상승항 (모드 OFF면 0 — d_dq 러너들은 내부 처리)
    ...
    jw02 = RU.windows23(model_f, x32, JDS, law, spr=spr, k_rise=kr)
    j6j = RU.windows23(model_f, x32, JDS, law, W_override=0.6, spr=spr, k_rise=kr)
    j6c = RU.win429_06_23(x32, sp, ref, law, c_cvt, d_dq, spr=spr)
    s2s = RU.windows23(model_f, x32, ("s2s_gnd_0319",), law, spr=spr, k_rise=kr)
    say("  0604 창 ...")
