...
X0 = [0.4230,      # 무릎 건마찰   ← 공중 방향분해 실측 (배포 0.1177)
      0.31109858,  # 힙 건마찰     (배포 유지 · 실측 0.278 과 이미 정합)
      0.0340,      # 무릎 속도비례 ← 실측 (배포 0.2281 = 실측의 6.7 배)
      0.00710734,  # 힙 속도비례   (배포 유지 · 실측 ~0 과 정합)
      3.29897169, 0.02239186, 166.33689904,
      0.00450849, 0.00071771,
      0.02995018,
      0.0164,      # 힙 모터축 관성  ← 자유 흔들림 실측 (배포 0.010)
      0.0130,      # 무릎 모터축 관성 ← 미측정, 힙과 같은 비율로 추정 (배포 0.00795)
      4.12241945, 2.37159815]
