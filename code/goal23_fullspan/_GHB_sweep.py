...
점수 (전부 낮을수록 좋음, 현행 스택 = 1.000)
  ...
  적합 세션 = 0424·0429·0602·0722·0723·0724·0725·0727
  게이트 전용 = **0324(별도 보관본)·0421(위치제어)** — 목적함수에 절대 안 들어간다.
  게이트 = 위 둘의 주입재생 + 0421·0429 폐루프. 기준선보다 2% 넘게 나빠지면 벌점.
...
FIT = ("26.04.24", "26.04.29", "26.06.02", "26.07.22",
...
EXTRA = {
    "canon_cap":  [("무릎 보정상한", 2.0, 6.5, 3.8), ("힙 보정상한", 1.2, 4.5, 2.6)],
    "canon_fric": [("무릎 하중기울기", 0.05, 0.60, 0.30), ("힙 하중기울기", 0.05, 0.60, 0.30),
                   ("무릎 속도문턱", 0.10, 3.00, 1.0), ("힙 속도문턱", 0.10, 3.00, 1.0)],
}
