...
사용 (cwd 무관):
  python code/bench/bench.py eval <candidate.json> [--judge p19|p20|p22|p23|p24|modea|p14] [--tol 0.005]
...
def do_eval(path, judge="p19", tol=0.005, quiet=False):
    ...
    r = {"p20": A.eval_p20, "p22": A.eval_p22, "p23": A.eval_p23,
         "p24": A.eval_p24}.get(judge, A.eval_p19)(cand)
    if not quiet:
...
def main():
    ...
    c.add_argument("--judge", default="p19",
                   choices=["p19", "p20", "p22", "p23", "p24", "modea", "p14"])
