...
**현행 런타임 스택: H1_260811** (베이스 p24) — 마라톤H H1 = G26_0811 + 커맨드 출력 1차지연 2ms (모터 전류루프 대역). 폐루프 전용 — 주입재생·점프높이 불변  (승격 2026-08-11)
...
FS_CMD_LPF=0.002
```
- 폐루프 전 세션 -5.41% (무릎토크 -12%, 무릎각 -7%, 최악 세션 0723 +1.3%)
- ModeA 전 세션 +0.00% · 점프높이 +0.00% (구조적으로 폐루프 전용)
- 게이트: 0421 CL -4.40%(개선) · 0429 CVT CL +1.55% · 0324/0421 ModeA +0.00% — 전부 통과
- J_H 1.000 -> 0.9784. 지연 0.003/0.005 는 변속 CL +2.91/+6.68% 로 게이트 위반
