...
**현행 런타임 스택: H2_260811** (베이스 p24) — 마라톤H H2 = H1 + 마찰구속 강성비 100->20 + 무릎 커맨드 1차지연 2->2.5ms (관절별 분리). 두 축은 상호작용 없음(21쌍 검사에서 |0.05|%p)  (승격 2026-08-11)
...
FS_IMPRATIO=20
```
- 폐루프 -0.43% (무릎토크 -1.37% · 무릎속 -0.93% 주도) · 세션 0424 -2.07% 0602 -1.78%
- 주입재생 +0.18% (힙각 절대 +0.030deg — 물리적으로 무시 가능) · 점프높이 +2.2%
- 미끄러짐 -6.3%: 하강 차이 4.3->3.7mm 상관 +0.72->+0.78 · 도약 8.4->8.2mm 상관 +0.74->+0.77
- 게이트 전부 통과: 0324 MA +0.65 · 0421 MA +1.64 · 0421 CL -0.64 · 0429 MA +0.00 · 0429 CL +1.15
- 정확도 점수 1.000->1.0034 (한도 +2% 이내) · 슬립 점수 1.000->0.937
