...
**현행 런타임 스택: fs16** (베이스 p24) — 마라톤 C·D·E 산물 (4ms qd 스큐 + 실게인 + 관측 lpf + 발 Karnopp stick-slip). 사용자 승격 2026-08-02. **마라톤F(08-02) 후 CVT 폐쇄 초기화 버그픽스 반영** — 승격 후보는 0건  (승격 2026-08-02)
...
```
- J_push (fit 8세션 push, fs14 정규화) **0.8243** (fs15 0.8543 · fs14 1.000) · |Δh| 14.13cm · τ2 24.57 (재구성 바닥 22.40)
- 그래프 규약 CL 세션합 (OLD→fs16): q1 −73% · q2 −61% · dq1 −56% · dq2 −58% · τ1 −31% · τ2 −21%
- **CVT(0429) 마라톤F 버그픽스 후**: CL 창평균 q1 1.21 · q2 2.19(구 15.07, −85%) · dq1 1.02 · dq2 3.81(−66%) · τ1 1.96 · τ2 6.79(−58%) — 일반 세션 수준 정상화
- 102칸(세션×모드×채널) OLD 대비 개선 85 · 악화 17 (전부 fs 계열 상속, fs16 신규 0)
- 가드: held-out 0324 MA · 배포앵커 27일/100_1.5_250_3 6채널 · μ_s≥0.85 · 정적홀드 0.86>0.853 · U-보드(fs_uboard) 기준표 _F_uboard_fs16.json
- **사용자 판단 대기 (마라톤F 재량 항목)**: svg25 (J 0.8204·|Δh| 12.54·τ2 22.88·held-out −41% 전부 개선이나 fit-MA 11건 위반) / svgp15,30 (가드 전통과·J +0.0001 초과)
- 차기 1순위 이월: 명시 벨트 SEA (유지+저장 통일 — REJECTED #21·#67 합류). 점프높이 잔여 ~10cm는 SEA 없이 게이트 내 회수 불가
