...
② <b>dq_des 전송 버그</b> (사용자 확인): 03.24/04.21은 코드 오류로 계획 dq_des 대신 0이 전송됨 —
...
0421의 계통적 overshoot(1.155)는 별개의 ill-posed 소점프 replay. <b>함의: 배포 전 dq_des 실전송 검증 필수
(deploy README에 추가), 새 세션+중간영역 궤적에서는 0602 수준 정확도 기대 가능.</b></p></div>
