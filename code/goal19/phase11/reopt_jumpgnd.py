...
LAM_GRF = 2.0
OUT = REPO / "code/goal19/phase11/reopt_jumpgnd_best.json"
...
ALL = [e for e in list_experiments() if e[0]=="sit2stand_gnd_0319" or e[0].startswith("jump_")]  # gnd+jumps only (drop air)
...
def main():
    import cma
    x0n = (X0 - LO) / (HI - LO)
    es = cma.CMAEvolutionStrategy(x0n, 0.22, {"bounds": [0, 1], "maxfevals": 200,
